...
Please check [LabelRecognizerParameter.GrayscaleTransformationModes](../code-parser-parameter/grayscale-transformation-modes.md#grayscaletransformationmodes) for reference.
...
Please check [LabelRecognizerParameter.ColourConversionModes](../code-parser-parameter/colour-conversion-modes.md#colourconversionmodes) for reference.
...
Please check [LabelRecognizerParameter.TextureDetectionModes](../code-parser-parameter/texture-detection-modes.md#texturedetectionmodes) for reference.

## CharacterNormalizationModes
Please check [LabelRecognizerParameter.CharacterNormalizationModes](../code-parser-parameter/character-normalization-modes.md#characternormalizationmodes) for reference.