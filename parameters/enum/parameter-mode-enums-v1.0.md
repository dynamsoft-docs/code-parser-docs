...
### Remarks
Check arguments of [`DLRBinarizationModes`]({{ site.parameters-reference }}code-parser-parameter/binarization-modes.html#mode-arguments) for available argument settings.
...
### Remarks
Check arguments of [`DLRRegionPredetectionModes`]({{ site.parameters-reference }}code-parser-parameter/region-predetection-modes.html#mode-arguments) for available argument settings.
